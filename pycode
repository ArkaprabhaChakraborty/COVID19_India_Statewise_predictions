...
data = pd.read_csv('/content/Datasets/Confirmed.csv', header=0, index_col=0)
data.head()

rf = pd.read_csv('/content/Datasets/Deceased.csv',header=0, index_col=0)
rf.head()

jf = pd.read_csv('/content/Datasets/Recovered.csv',header=0, index_col=0)
...
pyplot.show()
plt.savefig('/content/Images_India/India_mean_daily_Confirm_cases.png')

va = data.var()
va.plot()
plt.ylabel("Variance of Daily cases")
pyplot.show()
plt.savefig('/content/Images_India/India_variance_daily_Confirm_cases.png')

sc = data.std()
sc.plot()
plt.ylabel("Standard Deviation Of daily cases")
pyplot.show()
plt.savefig('/content/Images_India/India_standard_daily_Confirm_cases.png')
...
pyplot.show()
plt.savefig('/content/Images_India/India_confirmed_trend.png')
...
india_plot.savefig('/content/Images_India/india_confirm.png');
india_forecast_plot = m.plot_components(forecast)
india_forecast_plot.savefig('/content/Images_India/India_confirm_components.png');
...
for j in ['Maharashtra','Delhi',	'Gujrat',	'Madhya Pradesh',	'Tamilnadu',	'Rajasthan',	'Uttar Pradesh',	'Telengana',	'Andhra Pradesh', 'Kerala',	'Karnataka',	'Jammu And Kashmir',	'West Bengal',	'Harayana',	'Punjab',	'Bihar',	'Orissa',	'Uttarakhand',	'Himachal Pradesh',	'Chattisgarh',	'Assam',	'Jharkhand',	'Chandigarh',	'Ladakh',	'Andaman And Nicobar',	'Meghalaya',	'Goa',	'Puducherry',	'Manipur',	'Tripura',	'Arunachal Pradesh',	'Mizoram','Nagaland','Dadra And Nagar Haveli','Daman And Deu','Lakshadweep']:
  ...
  pyplot.show()
  plt.savefig('/content/Images_statewise_confirmed_plot/'+j+'_mean.png')
...
pyplot.show()
plt.savefig('/content/Images_India/India_deaths_trend.png')
...
india_plot = m.plot(forecast)
plt.ylabel("No. of Cases for India")
india_plot.savefig('/content/Images_India/india_deceased_seasonalities.png');
india_forecast_plot = m.plot_components(forecast)
india_forecast_plot.savefig('/content/Images_India/India_deceased_components.png');
...
for j in ['MAHARASHTRA', 'DELHI',	'GUJRAT',	'MADHYA PRADESH',	'TAMILNADU',	'RAJASTHAN',	'UTTAR PRADESH',	'TELENGANA',	'ANDHRA PRADESH', 'KERALA',	'KARNATAKA',	'JAMMU AND KASHMIR',	'WEST BENGAL',	'HARAYANA',	'PUNJAB',	'BIHAR',	'ORISSA',	'UTTARAKHAND',	'HIMACHAL PRADESH',	'CHATTISGARH',	'ASSAM',	'JHARKHAND',	'CHANDIGARH',	'LADAKH',	'ANDAMAN AND NICOBAR',	'MEGHALAYA',	'GOA',	'PUDUCHERRY',	'MANIPUR',	'TRIPURA',	'ARUNACHAL PRADESH',	'MIZORAM','NAGALAND','DADRA AND NAGAR HAVELI','DAMAN AND DEU','LAKSHADWEEP']:
  ...
  pyplot.show()
  plt.savefig('/content/Images_statewise_deaths_plot/'+j+'_deathtrend.png')
...
pyplot.show()
plt.savefig('/content/Images_India/India_recovered_trend.png')
...
india_plot = m.plot(forecast)
plt.ylabel("No. of Cases for India")
india_plot.savefig('/content/Images_India/india_recovered_seasonalities.png');
india_forecast_plot = m.plot_components(forecast)
india_forecast_plot.savefig('/content/Images_India/India_recovered_components.png');
...
for j in ['MAHARASHTRA', 'DELHI',	'GUJRAT',	'MADHYA PRADESH',	'TAMILNADU',	'RAJASTHAN',	'UTTAR PRADESH',	'TELENGANA',	'ANDHRA PRADESH', 'KERALA',	'KARNATAKA',	'JAMMU AND KASHMIR',	'WEST BENGAL',	'HARAYANA',	'PUNJAB',	'BIHAR',	'ORISSA',	'UTTARAKHAND',	'HIMACHAL PRADESH',	'CHATTISGARH',	'ASSAM',	'JHARKHAND',	'CHANDIGARH',	'LADAKH',	'ANDAMAN AND NICOBAR',	'MEGHALAYA',	'GOA',	'PUDUCHERRY',	'MANIPUR',	'TRIPURA',	'ARUNACHAL PRADESH',	'MIZORAM','NAGALAND','DADRA AND NAGAR HAVELI','DAMAN AND DEU','LAKSHADWEEP']:
  ...
  pyplot.show()
  plt.savefig('/content/Images_statewise_recovered_plot/'+j+'_normal.png')
